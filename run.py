...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='./dataset/TimesNet-CDConv/', help='root path of the data file')
    parser.add_argument('--train_data', type=str, required=True, help='train data file')
    parser.add_argument('--test_data', type=str, required=True, help='test data file')
    parser.add_argument('--features', type=str, default='MS',
                        help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
    parser.add_argument('--target', type=str, default='available', help='target feature in S or MS task')
    parser.add_argument('--freq', type=str, default='m',
                        help='freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
    parser.add_argument('--checkpoints', type=str, default='./checkpoints/', help='location of model checkpoints')
    parser.add_argument("--process_data", type=int, required=True, default=0,
                        help="process data type or not.")
    parser.add_argument("--identification", type=int, required=True, default=1,
                        help="identification super long cycle or not.")
    ...
    parser.add_argument('--batch_size', type=int, help='batch size of train input data', default=-1)
